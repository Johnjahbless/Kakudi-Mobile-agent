      ...
      <div className="main-content">
       ...
       <div className="section-header">
            ...
            <div className="section-header-breadcrumb">
              ...
              <div className="breadcrumb-item">Agent Management</div>
            </div>
          </div>
                ...
                <div className="card">
                  <div className="card-header">
                    ...
                    <div className="card-header-action">
                        <button className="btn btn-outline-secondary" data-toggle="modal" data-target="#mediumModal">Add Agent <i className="fas fa-plus-circle"></i></button>
                      </div>
                  </div>
              ...
              <table className="table table-striped" id="table-1">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><Link to="/user-profile" className="btn btn-secondary">Detail</Link></td>
                  </tr>
